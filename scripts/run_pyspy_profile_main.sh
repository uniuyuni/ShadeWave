...
export LIBRAW_LOCAL_PREFIX="${ROOT_DIR}/third_party/libraw-install"
export PKG_CONFIG_PATH="${ROOT_DIR}/third_party/libraw-install/lib/pkgconfig:${PKG_CONFIG_PATH:-}"
...
export DYLD_FALLBACK_LIBRARY_PATH="${ROOT_DIR}/third_party/libraw-install/lib:${ROOT_DIR}/.pixi/envs/default/lib:/usr/lib:/usr/local/lib:/opt/homebrew/lib"
