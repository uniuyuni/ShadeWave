...
setup(
    ...
    ext_modules=[
        ...
        Extension(
            ...
            ["film_grain_pybind.cpp", "film_grain_cpu.c"],
            include_dirs=[pybind11.get_include(), *_openmp_include_dirs],
            library_dirs=_openmp_library_dirs,
            language="c++",
            extra_compile_args=_openmp_compile_args,
        ...
        Extension(
            "effect_backends._lens_aberration_metal",
            ["lens_aberration_metal.mm"],
            include_dirs=[pybind11.get_include()],
            language="c++",
            extra_compile_args=["-O3", "-std=c++17", "-fobjc-arc"],
            extra_link_args=["-framework", "Metal", "-framework", "Foundation"],
        ...
        Extension(
            "effect_backends._coating_metal",
            ["coating_metal.mm"],
            include_dirs=[pybind11.get_include()],
            language="c++",
            extra_compile_args=["-O3", "-std=c++17", "-fobjc-arc"],
        ...
        Extension(
            "effect_backends._lens_effect_metal",
            ["lens_effect_metal.mm"],
            include_dirs=[pybind11.get_include()],
            language="c++",
            extra_compile_args=["-O3", "-std=c++17", "-fobjc-arc"],
            extra_link_args=["-framework", "Metal", "-framework", "Foundation"],
        ...
        Extension(
            "effect_backends._lens_blur_metal",
            ["lens_blur_metal.mm"],
            include_dirs=[pybind11.get_include()],
            language="c++",
            extra_compile_args=["-O3", "-std=c++17", "-fobjc-arc"],
